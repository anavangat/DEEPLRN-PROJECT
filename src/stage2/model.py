...
Four conv blocks (32-64-128-256), each
3x3 stride 1 -> BatchNorm -> ReLU -> 2x2 MaxPool; 
then Global Average Pooling -> FC 512 -> ReLU -> Dropout -> FC 36.

NOTE ON SOFTMAX: the module returns raw logits because nn.CrossEntropyLoss
applies log-softmax internally; adding a Softmax layer here
would apply it twice and cripple the gradients.
"""
